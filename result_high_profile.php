...
<?php 
	...
	$query = "SELECT Count(*) as count FROM MEMBERS WHERE high_profile = 1";
	...
	if (!$result) {
		...
		$high_profile_count = mysqli_fetch_object($result);
?>

<div class="main">
	<div class="grid_details">
		<h2> <?php echo $high_profile_count->count . " " ; ?>High Profile Members</h2>
